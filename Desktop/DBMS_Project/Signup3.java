...
public class Signup3 extends JFrame implements ActionListener{
    ...
    Signup3(){
        ...
        c7 = new JCheckBox("I hereby declares that the above entered details are correct.",true);
        ...
        try{
            ...
            if(ae.getSource()==b1){
                ...
                if(b.equals("")){
                    ...
                    conn c1 = new conn();
                    String q1 = "insert into signup3 values('"+a+"','"+first8+"','"+c+"','"+first4+"','"+b+"')";  
